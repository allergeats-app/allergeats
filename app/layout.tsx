  ...
  return (
    <html lang="en">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `(function(){try{var m=localStorage.getItem('alegeats_theme');var dark=m==='dark'||(m!=='light'&&window.matchMedia('(prefers-color-scheme: dark)').matches);if(dark){var r=document.documentElement;r.style.setProperty('--c-bg','#0f0f0f');r.style.setProperty('--c-card','#1c1c1e');r.style.setProperty('--c-border','#2c2c2e');r.style.setProperty('--c-text','#f2f2f7');r.style.setProperty('--c-sub','#8e8e93');r.style.setProperty('--c-input','#252528');r.style.setProperty('--c-muted','#2c2c2e');r.style.setProperty('--c-hdr','rgba(15,15,15,0.95)');r.style.setProperty('--c-risk-safe','#34d399');r.style.setProperty('--c-risk-ask','#fbbf24');r.style.setProperty('--c-risk-avoid','#f87171');r.style.setProperty('--c-brand','#29d5e8');r.style.setProperty('--c-brand-fg','#ffffff');r.style.setProperty('--c-brand-bg','rgba(41,213,232,0.12)');r.style.setProperty('--bn-circle-bg','#000000');r.style.setProperty('--bn-icon','#e5e7eb');r.style.setProperty('--bn-pill-bg','#000000');r.style.setProperty('--bn-pill-text','#6b7280');r.style.setProperty('--bn-bar-bg','#000000');r.style.setProperty('--bn-fade-start','rgba(0,0,0,0)');r.style.setProperty('--bn-fade-s1','rgba(0,0,0,0.03)');r.style.setProperty('--bn-fade-s2','rgba(0,0,0,0.09)');r.style.setProperty('--bn-fade-s3','rgba(0,0,0,0.20)');r.style.setProperty('--bn-fade-s4','rgba(0,0,0,0.38)');r.style.setProperty('--bn-fade-s5','rgba(0,0,0,0.60)');r.style.setProperty('--bn-fade-s6','rgba(0,0,0,0.80)');r.style.setProperty('--bn-fade-s7','rgba(0,0,0,0.93)');r.style.setProperty('--bn-fade-end','rgba(0,0,0,1)');}}catch(e){}})()`}} />
        <script
