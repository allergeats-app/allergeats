    ...
    <main style={{ minHeight: "100dvh", background: "var(--c-bg)", fontFamily: "Inter, Arial, sans-serif" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "32px 20px", paddingBottom: "max(48px, calc(32px + env(safe-area-inset-bottom)))" }}>
        ...
        <Section title="13. User Accounts">
          You are responsible for maintaining the confidentiality of your account credentials and for all activity that occurs under your account. You agree to provide accurate, current, and complete information when creating your account and to keep it updated. Notify us immediately at <a href="mailto:legal@allergeats.com" style={{ color: "var(--c-brand)" }}>legal@allergeats.com</a> if you suspect unauthorized use of your account. We are not liable for losses resulting from unauthorized use of your account.
        </Section>
        ...
        <Section title="22. Contact">
          ...
          <a href="mailto:legal@allergeats.com" style={{ color: "var(--c-brand)" }}>legal@allergeats.com</a>
        </Section>
