    ...
    <main className={layout !== "map" ? "safe-pb" : undefined} style={{ minHeight: "100dvh", background: "var(--c-bg)" }}>
      ...
      {layout !== "map" && <div style={{ maxWidth: 600, margin: "0 auto", padding: "12px 16px 0" }}>
        ...
        <div className="chip-row" style={{
          ...
          {/* trailing spacer so last chip isn't flush against edge on iOS */}
      ...
      <div className={`rp-results rp-results--${layout}`}>
        {loading ? (
          ...
          <div style={{ padding: "56px 0 32px", textAlign: "center" }}>
            ...
            <CameraScanButton style={{ display: "inline-flex", alignItems: "center", gap: 7, padding: "12px 22px", background: "var(--c-brand)", color: "var(--c-brand-fg)", borderRadius: 12, fontWeight: 700, fontSize: 14, border: "none", cursor: "pointer" }}>
