        ...
        <div style={{
          ...
          <div style={{ display: "grid", gap: 10 }}>
            <button onClick={handleEnrollPasskey} disabled={passkeyEnrolling} style={{
              ...
              background: passkeyEnrolling ? "#9ca3af" : "var(--c-brand)", color: "var(--c-brand-fg)",
          ...
          <>
            ...
            <form onSubmit={handleForgotPassword} style={{ display: "grid", gap: 14 }}>
              ...
              <button type="submit" disabled={loading} style={{
                padding: "14px 0", borderRadius: 14, border: "none",
                background: loading ? "#9ca3af" : "var(--c-brand)", color: "var(--c-brand-fg)",
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
                  ...
                  {mode === "signin" && (
                    <button type="button" onClick={() => switchMode("forgot")}
                      style={{ background: "none", border: "none", fontSize: 12, color: "var(--c-brand)", fontWeight: 600, cursor: "pointer", padding: 0 }}>
                      Forgot password?
                    </button>
                  )}
                </div>
              ...
              {mode === "signin" && (
                <label style={{ display: "flex", alignItems: "center", gap: 10, cursor: "pointer", userSelect: "none", minHeight: 44, paddingLeft: 2 }}>
                  <input type="checkbox" checked={staySignedIn} onChange={(e) => setStay(e.target.checked)}
                    style={{ width: 20, height: 20, accentColor: "var(--c-brand)", cursor: "pointer", flexShrink: 0 }} />
