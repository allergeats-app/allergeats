    ...
    <main style={{ minHeight: "100dvh", background: "var(--c-bg)", paddingBottom: "max(80px, calc(60px + env(safe-area-inset-bottom)))" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ fontSize: 15, fontWeight: 900, color: "var(--c-text)" }}>History</span>
        </div>
        <SettingsButton />
      </div>
                      ...
                      <Link key={id} href={`/restaurants/${id}`} style={{ textDecoration: "none", color: "inherit" }}>
                        <div style={{
                          ...
                          <div style={{ display: "flex", alignItems: "center", gap: 8, minWidth: 0 }}>
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="#1fbdcc" stroke="none" style={{ flexShrink: 0 }}>
