          ...
          <div style={{ display: "grid", gap: 10, marginBottom: 32 }}>
            {[
              ...
              <div key={n} style={{ display: "flex", gap: 14, alignItems: "flex-start", background: "var(--c-bg)", border: "1px solid var(--c-border)", borderRadius: 16, padding: "14px 16px" }}>
                <div style={{ width: 32, height: 32, borderRadius: 10, background: "var(--c-brand)", color: "var(--c-brand-fg)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14, fontWeight: 900, flexShrink: 0 }}>{n}</div>
                <div>
